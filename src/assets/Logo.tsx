...
import logo from './logos/salestube_logo.png';
import logoNeg from './logos/salestube_logo_darkmode.png';
...
export default function Logo({ size = 1.5, ...props }: ILogoProps) {
  ...
  return (
    ...
    // </svg>
    <div>
      <img src={theme.palette.mode === 'light' ? logo : logoNeg} style={{height: '170px'}} alt='Salestube logo' />
    </div>
